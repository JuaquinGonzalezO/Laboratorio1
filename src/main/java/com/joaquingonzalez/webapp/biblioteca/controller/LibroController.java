...
import com.joaquingonzalez.webapp.biblioteca.service.LibroService;
...
public class LibroController {
    ...
    @GetMapping("/libros")
    public ResponseEntity<List<Libro>> listarLibros( Long id){
       try {
   ...
   @GetMapping("/libro")
    ...
    public ResponseEntity<Map<String, String>>agregarLibro(@RequestBody Libro libro){
        ...
        try {
           ...
           response.put("error", "Hubo un error al crear el libro");
    ...
    public ResponseEntity<Map<String,String>> editarLibro(@PathVariable Long id, @RequestBody Libro libroNuevo){
        ...
        try {
            ...
            response.put("message", "Error");
            response.put("err", "Hubo un errro al modificar el libro");
            return ResponseEntity.badRequest().body(response);
